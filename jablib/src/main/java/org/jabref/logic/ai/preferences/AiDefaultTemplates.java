...
public class AiDefaultTemplates {
    private static final Map<AiTemplateKind, String> TEMPLATES = Map.of(
            AiTemplateKind.CHATTING_SYSTEM_MESSAGE, """
            ...
            AiTemplateKind.CHATTING_USER_MESSAGE, """
                    $message
            ...
            AiTemplateKind.SUMMARIZATION_CHUNK_SYSTEM_MESSAGE, """
            ...
            AiTemplateKind.SUMMARIZATION_CHUNK_USER_MESSAGE, "$text",

            AiTemplateKind.SUMMARIZATION_COMBINE_SYSTEM_MESSAGE, """
            ...
            AiTemplateKind.SUMMARIZATION_COMBINE_USER_MESSAGE, "$chunks",

            // Defaults for full-document summarization
            AiTemplateKind.SUMMARIZATION_FULL_DOCUMENT_SYSTEM_MESSAGE, """
            ...
            AiTemplateKind.SUMMARIZATION_FULL_DOCUMENT_USER_MESSAGE, "$text",

            AiTemplateKind.CITATION_PARSING_SYSTEM_MESSAGE, "You are a bot to convert a plain text citation to a BibTeX entry. The user you talk to understands only BibTeX code, so provide it plainly without any wrappings.",
            AiTemplateKind.CITATION_PARSING_USER_MESSAGE, "Please convert this plain text citation to a BibTeX entry:\n$citation\nIn your output, please provide only BibTeX code as your message."
    );

    public static String getTemplate(AiTemplateKind template) {
